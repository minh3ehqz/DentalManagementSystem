...
namespace DentalManagementSystem.Utils
{
    ...
    {
        private static readonly string _from = "dopi4720@gmail.com"; // Email của Sender (của bạn)
        private static readonly string _pass = "rzufzwidnbqctnee"; // Mật khẩu Email của Sender (của bạn)
